...
const TrustCards = () => {
  const cards = [
    { title: 'Decades of Expertise', desc: 'Experience-driven financial guidance built around long-term thinking.' },
  ...
  return (
    <section className="py-20 px-12 bg-[#F4F8FC]">
      <div className="container mx-auto text-center mb-16">
        ...
        <h2 className="text-4xl font-bold text-[#123B7A] mb-4">A More Thoughtful Approach To Wealth</h2>
      </div>
