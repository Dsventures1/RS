    ...
    <>
      <section className="py-12 md:py-20 px-6 md:px-12 bg-[#F8FAFC]">
        <div className="container mx-auto px-0 md:px-6 text-center border-t border-slate-200 pt-12">
            ...
            <a href="https://wa.me/919987974931" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#2563EB] text-white px-8 py-4 rounded font-semibold mt-6">Book a Consultation</a>
        </div>
      </section>
